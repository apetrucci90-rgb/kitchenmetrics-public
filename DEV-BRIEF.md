...
**12,694 assertions across thirty-six suites**, all green, run after every change
...
**12.694 asserzioni in trentasei suite**, tutte verdi, eseguite dopo ogni modifica (31 luglio 2026). La cifra viene rigenerata da `tests/run_all.js` anziché essere ricordata a memoria — era andata fuori sincrono due volte prima dell'esistenza di questo runner.
