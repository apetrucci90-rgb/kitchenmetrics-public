...
| **Thermal Cooking Calculator** | Ramp and hold times from the Choi-Okos model and Bigelow pathogen kinetics, 6-log reduction, 1108 food profiles. |
| **Lipid Science Database** | 148 fats and oils: smoke point, safe temperature, crystallisation, density, fatty-acid profile, oxidation risk, allergens. Two disclosed defects: the attribution field names a journal or an organisation rather than a document (40 distinct strings, one carrying a year), and the crystallisation column holds a temperature on 135 rows and a crystal habit on the other 13. Both are stated in the app rather than tidied away. |
